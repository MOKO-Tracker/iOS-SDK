...
+ (MKAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAdvTriggerCellIdenty"];
    }
    return cell;
}
